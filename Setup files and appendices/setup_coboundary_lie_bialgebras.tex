...
\begin{lemma}[Drinfeld] \label{lemma: coboundary_lie_bialgebras_and_CYBEs}
    ...
    given by equation \eqref{equation: coboundary_lie_cobrackets} (and hence this topological Lie bialgebra structure is automatically coboundary) if and only if $\CYBE(\calr)$ is an invariant alternating element of $\a \hattensor \a \hattensor \a$, i.e. if and only if:
