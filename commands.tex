...
\newcommand\schouten[2][]{#1\left[ \! \left[ {#2} #1\right] \! \right]}
...
\DeclareFontFamily{U}{stix2bb}{\skewchar\font200 }
\DeclareFontShape{U}{stix2bb}{m}{n} {<-> stix2-mathbb}{}
\DeclareMathAlphabet{\mathbbm}{U}{stix2bb}{m}{n}
...
\newcommand{\CE}{\operatorname{CE}} %chevalley-eilenberg complex
...
\newcommand{\NL}{\mathbbm{NL}} %naive cotangent complex
